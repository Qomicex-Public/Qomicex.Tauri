...
export default function ShaderCard({ shader, instanceId, gameDir, gameVersion, loader, onDelete, viewMode = 'compact', selected, onSelect }: Props) {
  const { t } = useI18n()
