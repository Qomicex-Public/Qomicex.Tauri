...
export const PageCam: React.FC<{
  ...
  blur?: number;
  saturate?: number;
  bg?: string; // background behind the page texture (template default cream)
  ...
  frame?: number;
}> = ({ src, pageH, keys, children, blur = 0, saturate = 1, bg = '#faf7f2', ease = Easing.bezier(0.33, 0, 0.15, 1), dof, frame: frameProp }) => {
