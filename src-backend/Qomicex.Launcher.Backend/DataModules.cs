    ...
    public class DataModules
    {
        public class DataDetails
        {
            public class Account
            {
                ...
                public string AccessToken { get; set; } = "faked-token-for-offline";
            ...
            public class Version
            {
                ...
                public string Name
                {
                    ...
                    set
                    {
                        ...
                        GameVersion = _name;
                        Qomicex.Launcher.Backend.Modules.Helpers.GeneralHelper helper = new Qomicex.Launcher.Backend.Modules.Helpers.GeneralHelper();
